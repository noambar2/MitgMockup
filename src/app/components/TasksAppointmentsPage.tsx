...
const tasks: Task[] = [
  ...
  },
  {
    ...
    kind: "שאלון",
    status: "טרם בוצע",
    timeLeft: "נותרו 7 ימים למילוי",
    preview:
      "מטרת השאלון היא הבעת רצון להצטרף לתהליך המיון לעתודה ולבחירת תחום הלימוד ומוסד אקדמי בו תרצו להשתלב. עליכם לדרג עד ארבעה תחומי לימוד המעניינים אתכם, ובכל תחום לימוד לדרג עד שלושה מוסדות לימוד אקדמיים.",
    action: "מעבר לשאלון",
  },
  {
    id: "survey",
    name: "סקר חוויית צו ראשון",
    kind: "סקר",
    status: "טרם בוצע",
    timeLeft: "נותרו 14 ימים למילוי",
    preview:
      "לאחר השלמת הליך הצו הראשון נשמח לשמוע איך היה. הסקר בודק את שביעות רצונך מכל אחת מתחנות היום, מההכנה המקדימה ומההתנהלות בלשכת הגיוס - ונמשך כ-5 דקות.",
    action: "מעבר לסקר",
  },
  {
    id: "documents",
