        ...
        {step === "intro" && (
          <div className="flex flex-col gap-6">
            ...
            <p className="text-[#171c23] text-[15px] leading-relaxed text-right">
              ...
              להשתלב. עליכם לדרג עד ארבעה תחומי לימוד המעניינים
              אתכם, ובכל תחום לימוד לדרג עד שלושה מוסדות לימוד
              אקדמיים בהם הנכם מעוניינים ללמוד. בעדיפות הראשונה
              יש לציין את התחום בו תרצו להשתלב בעדיפות הגבוהה
              ביותר וכן הלאה.
            </p>
