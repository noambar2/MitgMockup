    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3 text-[#171c23] text-[16px] leading-relaxed text-right">
        <p>
          ...
          ולבחירת תחום הלימוד ומוסד אקדמי בו תרצו להשתלב.
        </p>
        <p>
          עליכם לדרג עד ארבעה תחומי לימוד המעניינים אתכם, ובכל
          תחום לימוד לדרג עד שלושה מוסדות לימוד אקדמיים בהם הנכם
          מעוניינים ללמוד.
        </p>
        <p>
